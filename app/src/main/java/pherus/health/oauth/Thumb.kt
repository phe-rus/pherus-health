...
import pherus.health.ui.theme.onPrimaryContainerDark
import pherus.health.ui.theme.onSecondaryDark
import pherus.health.ui.theme.primaryDark
...
fun calculateTrackColor(swipeFraction: Float): Color {
    ...
    return lerp(primaryDark, onPrimaryContainerDark, fraction)
}
...
fun Thumb(
    ...
    Box(
        ...
        if (isLoading) {
            ...
            Image(
                painter = painterResource(R.drawable.pherus),
...
fun calculateHintTextColor(swipeFraction: Float): Color {
    ...
    return lerp(onSecondaryDark, onSecondaryDark.copy(alpha = 0f), fraction)
}
